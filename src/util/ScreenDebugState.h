...
class ScreenDebugState {
 public:
  ...
  void setHeaderIfEmpty(const std::string& title);
  void setDiagnostics(const ScreenDebugDiagnostics& diagnostics);
  void setSubHeader(const char* label, const char* rightLabel);
  void setSubHeaderIfEmpty(const std::string& label, const std::string& rightLabel);
